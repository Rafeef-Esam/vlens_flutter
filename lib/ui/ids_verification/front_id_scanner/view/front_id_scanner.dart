...
class FrontIdScanner extends StatefulWidget {
  const FrontIdScanner({super.key});

  @override
  State<FrontIdScanner> createState() => _FrontIdScannerState();
}

class _FrontIdScannerState extends State<FrontIdScanner> {
  ...
  // navigation
  static navigateToBackIdScanner(BuildContext context) {
    Navigator.push(context,
        MaterialPageRoute(builder: (context) => const BackIdScanner()));
  }

  static navigateToInstructions(BuildContext context) {
    Navigator.push(context,
        MaterialPageRoute(builder: (context) => const IDsInstructionsScreen()));
  }
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            CameraHeader(
              onBackTap: () => navigateToInstructions(context),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                onPressed: () {
                                  navigateToBackIdScanner(context);
